...
if ($_SESSION['role'] === 'admin') {
    ...
    $users = query("SELECT * FROM users WHERE role = 'operator' ORDER BY created_at DESC");
} else {
    $users = query("SELECT * FROM users WHERE id_user = $_SESSION[id_user] ORDER BY created_at DESC");
}
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($users as $user) : ?>
                                        <tr>
                                            ...
                                            <td><?= $user['username']; ?></td>
                                            <td><?= $user['email']; ?></td>
                                            <td><?= $user['role'] ? 'admin' : 'operator'; ?></td>
